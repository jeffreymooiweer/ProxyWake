...
- Images are also published to GitHub Container Registry as `ghcr.io/jeffreymooiweer/proxywake`, with the same tags as Docker Hub, from the same workflow run
