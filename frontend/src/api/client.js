...
export const api = {
  ...
  updateDeviceDependencies: (id, dependsOn) => request(`/api/devices/${id}/dependencies`, { method: 'PUT', body: JSON.stringify({ depends_on: dependsOn }) }),
  getDeviceDependencies: (id) => request(`/api/devices/${id}/dependencies`),
  updateDeviceCredentials: (id, credentials) => request(`/api/devices/${id}/credentials`, { method: 'PUT', body: JSON.stringify({ credentials }) }),
